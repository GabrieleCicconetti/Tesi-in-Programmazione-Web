...
<div class="col-xs-12 row-esame-utente" draggable="true" id="<?=$_GET['id']?>-eu">
    ...
    <div class="row">
        ...
        <div class="col-xs-2 border-right text-center"><button class="modifica-esame-utente btn btn-primary"><i class="far fa-edit"></i></button></div>
        ...
        <div class="col-xs-2 cfu-esame-utente border-right"><h6 class="text-center"><?=$_GET['cfu']?></h6></div>
